...
with_node \
  ...
  --target "/Users/sebb/Documents/Development/Projects/papayal-mobile/ios/Pods/Target Support Files/Pods-papayalmobile/ExpoModulesProvider.swift" \
  --entitlement "/Users/sebb/Documents/Development/Projects/papayal-mobile/ios/papayalmobile/papayalmobile.entitlements" \
   \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-constants" "expo-device" "expo-file-system" "expo-font" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-localization" "expo-secure-store" "expo-splash-screen" "expo-web-browser"
